                    ...
                    case $this->table['OR']:
                        if ($record->tableData) {
                            ...
                            $orderUploadDto = new UploadDTO\OrderUploadDto(
                                    $record->tableData->orderId, 
                                    $record->tableData->custId,
                                    $record->tableData->orderStatus, 
                                    $record->tableData->orderDate, 
                                    $record->tableData->orderTime, 
                                    $record->tableData->orderAmount, 
                                    $record->tableData->userId, 
                                    $record->tableData->tableId);
                    ...
                    case $this->table['OD']:
                        if ($record->tableData) {
                            $orderDetailsUploadDto = new UploadDTO\OrderDetailsUploadDto(
                                    $record->tableData->orderDetailsId, 
                                    $record->tableData->orderPrice, 
                                    $record->tableData->orderQuantity, 
                                    $record->tableData->orderId, 
                                    $record->tableData->menuId, 
                                    $record->tableData->menuTitle);
