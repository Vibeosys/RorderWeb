...
<div class="col-md-6 col-sm-6 col-xs-12" id="shr">
    <div class="x_panel">
        <div class="x_title">
            <h2>Sales History <small>THIS MONTH</small></h2>
...
<div class="col-md-6 col-sm-6 col-xs-12" id="tr">
    <div class="x_panel">
        <div class="x_title">
            <h2>Transactions<small>TODAY</small></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="#"><i class="fa fa-download"></i> Download</a>
                </li>
            </ul>
...
<div class="col-md-6 col-sm-6 col-xs-12" id="rhr">
    <div class="x_panel">
        <div class="x_title">
            <h2>Rush Hour Report <small>DAILY</small></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="#"><i class="fa fa-download"></i> Download</a>
                </li>
            </ul>
...
<div class="col-md-6 col-sm-6 col-xs-12" id="mrr">
    <div class="x_panel">
        <div class="x_title">
            <h2>Material Requisition In gm/kg <small>TODAY</small></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="#"><i class="fa fa-download"></i> Download</a>
                </li>
            </ul>
...
<div class="col-md-6 col-sm-6 col-xs-12" id="mbrr">
    <div class="x_panel">
        <div class="x_title">
            <h2>Material Requisition In ml/ltr<small>TODAY</small></h2>
            <ul class="nav navbar-right panel_toolbox">
                <li><a href="#"><i class="fa fa-download"></i> Download</a>
                </li>
            </ul>
