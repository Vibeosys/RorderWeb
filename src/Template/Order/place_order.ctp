...
<li class="red"><a class="red" href="../../<?= $option ?>/placeorder"><?php
        if ($option == "tableview") {
            echo 'Table List';
        } elseif ($option == "takeawayview") {
            echo 'Takeaway List';
        } elseif ($option == "deliveryview") {
            echo 'Delivery List';
        }
        ?></a></li>
...
<?php if (isset($categories)) {
    ...
    foreach ($categories as $cate) { ?>    
        ...
        } ?>  href="#<?= $cate->categoryTitle ?>" class="page-scroll all-cate"><?= $cate->categoryTitle ?>
                                        </a>
                                    </li>
        <?php $i++;
    }
                                                        ...
                                                        <ul>
                                                                    <?php if (isset($menus)) {
                                                                        ...
                                                                        foreach ($menus as $menu) {
                                                                            if ($cate->categoryId == $menu->categoryId) { ?> 

                                                                        <li> 
                                                                            <div class="details <?php if ($menu->fbTypeId == 3) {
                                                                                    echo 'submenu_items';
                                                                                } ?>">
                                                                                <div class="veg-tag">
...
<div class='popup'>
    ...
    <!--<img src='images/close.png' alt='quit' class='x' id='x' />-->
        <h3>Table No :<?php if (isset($tableNo)) echo $tableNo;
elseif ($takeawayNo) echo $takeawayNo;
elseif ($takeawayNo) echo $takeawayNo; ?></h3>
    ...
    $(document).ready(function () {
        ...
        $('#reserve_table').on('click', function () {
            ...
            $.post('/getwebuser', {}, function (result) {
                ...
                var operationData2 = {'arrivalTime': cur_time, 
                    'custId': cur_cust_id, 
                    'isWaiting': '0', 
                    'occupancy': '0', 
                    'tableId': cur_table, 'userId': result.userId};
